"""add timestamps to roles and audit_log tables

Revision ID: 0006_add_timestamps
Revises: 0005_create_audit_log
Create Date: 2025-08-06

This migration adds created_at and updated_at columns to the roles and
audit_log tables. These timestamp columns align the database schema
...
def downgrade():
    # Remove the timestamp columns from audit_log and roles tables if
